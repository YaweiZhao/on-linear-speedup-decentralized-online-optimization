...
\end{align} and $\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrnorm{\nabla h_t(\x; \xi_{i,t}) - \nabla h_t(\x)}^2 \le \sigma_{i,t}^2$.
...
\begin{align}
\nonumber
J_1(t) = & \frac{1}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrangle{\nabla h_t(\x_{i,t}), \x_{i,t} - \bar{\x}_t } \\ \nonumber
...
\refabovecir{\le}{\textcircled{1}} & \frac{L}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + \frac{1}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrangle{\nabla h_t(\bar{\x}_t), \x_{i,t} - \bar{\x}_t } \\ \nonumber
\le & \frac{L}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + \frac{1}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrincir{\frac{\eta}{2\nu}\lrnorm{\nabla h_t(\bar{\x}_t)}^2 + \frac{\nu}{2\eta}\lrnorm{\x_{i,t} - \bar{\x}_t }^2 } \\ \label{equa_theorem_temp0}
\le & \frac{L}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + \frac{\eta}{2\nu}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\nabla h_t(\bar{\x}_t)}^2 + \frac{\nu}{2\eta n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2. 
...
\le & \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} + 4G\eta\beta^2 +  \frac{\eta L^2(1-\beta)^2}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\bar{\x}_t - \x_{i,t} }^2 + 3GL\eta^2  + \frac{2L\eta^2}{n}\sum_{i=1}^n \sigma_{i,t}^2.
\end{align} Substituting \eqref{equa_theorem_temp1} into \eqref{equa_theorem_temp0}, we obtain
\begin{align}
\nonumber
& J_1(t) \\ \nonumber 
\le & \frac{L}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 +  \frac{1}{\nu} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} \\ \nonumber 
& + \frac{4G\eta\beta^2}{\nu} +  \frac{\eta L^2(1-\beta)^2}{n\nu}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\bar{\x}_t - \x_{i,t} }^2  \\ \nonumber 
&+ \frac{3GL \eta^2}{\nu} + \frac{2L\eta^2}{n\nu} \sum_{i=1}^n \sigma_{i,t}^2  + \frac{\nu}{2n\eta}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2  \\ \nonumber
= & \lrincir{ \frac{L}{n} + \frac{\eta L^2(1-\beta)^2}{n\nu} + \frac{\nu}{2n\eta} }\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2 + \frac{1}{\nu} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} \\ \nonumber 
...
\begin{align}
\nonumber
J_2(t) = & \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrangle{\frac{1}{n}\sum_{i=1}^n\nabla h_t(\x_{i,t};\xi_{i,t}), \bar{\x}_t - \bar{\x}_{t+1} } \\ \nonumber
...
\le &  \eta\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\frac{1}{n}\sum_{i=1}^n\nabla h_t(\x_{i,t};\xi_{i,t}) - \nabla h_t(\x_{i,t})}^2 + \eta \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\frac{1}{n}\sum_{i=1}^n\nabla h_t(\x_{i,t})}^2 \\ \nonumber 
& + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2  \\ \nonumber
\le & \frac{\eta}{n^2} \sum_{i=1}^n\sigma_{i,t}^2 + \eta \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\frac{1}{n}\sum_{i=1}^n\nabla h_t(\x_{i,t}) - \nabla h_t(\bar{\x}_t) + \nabla h_t(\bar{\x}_t)}^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2 \\ \nonumber
\le & \frac{\eta}{n^2} \sum_{i=1}^n\sigma_{i,t}^2 + 2\eta \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\frac{1}{n}\sum_{i=1}^n\nabla h_t(\x_{i,t}) - \nabla h_t(\bar{\x}_t) }^2 \\ \nonumber 
& + 2\eta \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\nabla h_t(\bar{\x}_t)}^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2 \\ \nonumber
\le & \frac{\eta}{n^2} \sum_{i=1}^n\sigma_{i,t}^2 + \frac{2\eta L^2}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t }^2 \\ \nonumber 
& + 2\eta \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\nabla h_t(\bar{\x}_t)}^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2.
\end{align} 
...
\nonumber
& J_2(t) \\ \nonumber 
\le & \frac{\eta}{n^2} \sum_{i=1}^n\sigma_{i,t}^2 + \frac{2\eta L^2}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t }^2 + 4\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} + 16 G\eta \beta^2   \\ \nonumber
& + \frac{4\eta L^2 (1-\beta)^2}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + 12GL\eta^2 + \frac{8L\eta^2}{n} \sum_{i=1}^n \sigma_{i,t}^2  + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2 \\ \nonumber
\le & \frac{\eta + 8nL\eta^2}{n^2} \sum_{i=1}^n\sigma_{i,t}^2 + \lrincir{ 2\eta L^2 + 4\eta L^2(1-\beta)^2 }\frac{1}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + 4\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} \\ \nonumber 
& + 16G\eta \beta^2 + 12GL\eta^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2 \\ \nonumber
\le & \frac{\eta + 8nL\eta^2}{n^2} \sum_{i=1}^n\sigma_{i,t}^2 + \frac{6\eta L^2}{n}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + 4\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} \\ \nonumber 
& + 16G\eta \beta^2 + 12GL\eta^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2.
...
& I_2(t) \\ \nonumber 
= & (1-\beta)(J_1(t) + J_2(t)) \\ \nonumber
= &  (1-\beta)\lrincir{ \frac{L}{n} + \frac{\eta L^2}{n\nu} + \frac{\nu}{2n\eta} + \frac{6\eta L^2}{n} }\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2  + (1-\beta)\lrincir{\frac{1}{\nu} + 4} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})}\\ \nonumber 
...
\le &  \lrincir{ \frac{L}{n} + \frac{\eta L^2}{n\nu} + \frac{\nu}{2n\eta} + \frac{6\eta L^2}{n} }\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2  + \lrincir{\frac{1}{\nu} + 4}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})}\\ \nonumber 
...
\nonumber
& I_1(t) + I_2(t) \\ \nonumber 
\le & \beta G \eta + \frac{\beta}{2n\eta }\sum_{i=1}^n \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\x_{i,t} - \bar{\x}_t}^2 + \frac{\beta }{2\eta } \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{\bar{\x}_t - \bar{\x}_{t+1}}^2 \\ \nonumber
& +  \lrincir{ \frac{L}{n} + \frac{\eta L^2}{n\nu} + \frac{\nu}{2n\eta} + \frac{6\eta L^2}{n} }\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2 + \lrincir{\frac{1}{\nu} + 4}\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})}\\ \nonumber 
&+  4G\eta\beta^2\lrincir{\frac{1}{\nu} + 4} +  \frac{1-\beta}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2 + 3LG\eta^2\lrincir{ \frac{1}{\nu} + 4 } + \frac{\nu(\eta + 8nL\eta^2) + 2nL\eta^2}{n^2\nu} \sum_{i=1}^n\sigma_{i,t}^2\\ \nonumber
\le & \lrincir{1 + 4\beta\lrincir{\frac{1}{\nu}+4}}\beta G \eta + \lrincir{ \frac{L}{n} + \frac{\eta L^2}{n\nu} + \frac{\nu}{2n\eta} + \frac{6\eta L^2}{n}  + \frac{\beta}{2n\eta} }\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\sum_{i=1}^n\lrnorm{\x_{i,t} - \bar{\x}_t }^2 \\ \nonumber 
...
\nonumber
& \frac{\eta}{2}\lrnorm{\nabla h_t(\bar{\x}_t)}^2 + \frac{\eta}{2}\lrnorm{\frac{1}{n}\sum_{i=1}^n \nabla f_{i,t}(\x_{i,t})}^2 \\ \nonumber 
\le & \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{h_t(\bar{\x}_t) - h_t(\bar{\x}_{t+1})} + 2G\eta\beta^2 +  \frac{\eta L^2(1-\beta)^2}{n}\sum_{i=1}^n\lrnorm{\bar{\x}_t - \x_{i,t} }^2 + 3GL\eta^2  + \frac{2L\eta^2}{n}\sum_{i=1}^n \sigma_{i,t}^2.
