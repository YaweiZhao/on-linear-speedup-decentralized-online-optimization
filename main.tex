...
\begin{align}
\nonumber
C_0 := & \sqrt{ \frac{\eta T \lrincir{ G + (1-\beta)\sigma^2 }}{\beta^2\eta T \lrincir{ G + (1-\beta)\sigma^2 } + (1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} } } }; \\ \nonumber
C_1 := & L + 6\eta L^2  + \frac{\beta}{\eta} + \eta L^2 C_0; \\ \nonumber
C_2 := & \lrincir{T\beta(\eta + 16nL\eta^2) + 2nTL\eta^2} C_0.
\end{align} Using Assumption \ref{assumption_bounded_gradient_domain} and \ref{assumption_difference_bound_distributions}, and choosing $\eta>0$ in Algorithm \ref{algo_dog}, we have 

\begin{align}
\nonumber
& \Rcal_T^{DOG} \\ \nonumber 
= & \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \sum_{t=1}^T\sum_{i=1}^n f_{i,t}(\x_{i,t};\xi_{i,t}) - f_t(\x_t^\ast;\xi_{i,t}) \\ \nonumber
\le & 31 nT\beta G \eta + 4(1-\beta)nT\eta \beta\sigma^2 +  \frac{C_1 \eta^2}{(1-\rho)^2}   \lrincir{ 6nTG + 4(1-\beta)nT \sigma^2 } \\ \nonumber 
&+ (C_0 + 4) (1-\beta)n \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V}  + 3(C_0 + 4) nTLG\eta^2 \\ \nonumber 
...
\begin{align}
\nonumber
\eta = \sqrt{  \frac{nM }{ T \lrincir{ \beta nG + (\beta+1)(1-\beta)\sigma^2 }  }  }
\end{align} in Algorithm \ref{algo_dog}, we have
\begin{align}
\nonumber
\Rcal_T^{DOG} \lesssim \sqrt{ n^2 \beta MTG + (n^2\beta + n)MT(1-\beta)\sigma^2 } + C_0 (1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} }.
\end{align}
...
\le & \frac{\eta + 16nL\eta^2}{n} \sigma^2 + \lrincir{ 2\eta L^2 + 4\eta L^2(1-\beta)^2 }\frac{1}{n}\EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + 4\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{H_t(\bar{\x}_t) - H_t(\bar{\x}_{t+1})} \\ \nonumber 
& + 24G\eta \beta^2 + 12GL\eta^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2 \\ \nonumber
\le & \frac{\eta + 16nL\eta^2}{n} \sigma^2 + \frac{6\eta L^2}{n}\EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} }\sum_{i=1}^n \lrnorm{\x_{i,t} - \bar{\x}_t}^2 + 4\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrincir{H_t(\bar{\x}_t) - H_t(\bar{\x}_{t+1})} \\ \nonumber 
& + 24G\eta \beta^2 + 12GL\eta^2 + \frac{1}{2\eta} \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} }\lrnorm{ \bar{\x}_t - \bar{\x}_{t+1}}^2.
...
\begin{align}
\nonumber
\nu = \sqrt{\beta^2 + \frac{(1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} }  }{\eta T \lrincir{ G + (1-\beta)\sigma^2 } }} \ge \beta,
\end{align} we finally have 
\begin{align}
\nonumber
& \Rcal_T^{DOG} \\ \nonumber 
= & \EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \sum_{t=1}^T\sum_{i=1}^n f_{i,t}(\x_{i,t};\xi_{i,t}) - f_t(\x_t^\ast;\xi_{i,t}) \\ \nonumber
\le & 31 nT\beta G \eta + 4(1-\beta)nT\eta \beta\sigma^2 + \lrincir{ L   + 6\eta L^2  + \frac{\beta}{\eta} } \frac{\eta^2}{(1-\rho)^2}   \lrincir{ 6nTG + 4(1-\beta)nT \sigma^2 } \\ \nonumber 
& + \frac{\eta^3 L^2\lrincir{ 6nTG + 4(1-\beta)nT \sigma^2 }}{(1-\rho)^2} \sqrt{ \frac{\eta T \lrincir{ G + (1-\beta)\sigma^2 }}{\beta^2\eta T \lrincir{ G + (1-\beta)\sigma^2 } + (1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} } } } \\ \nonumber
&+ (1-\beta)n \sqrt{ \frac{\eta T \lrincir{ G + (1-\beta)\sigma^2 } \lrincir{\EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V}}^2}{\beta^2\eta T \lrincir{ G + (1-\beta)\sigma^2 } + (1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} } } } \\ \nonumber
&  + 4 (1-\beta)n \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} \\ \nonumber
& + 3nTLG\eta^2\lrincir{ \sqrt{ \frac{\eta T \lrincir{ G + (1-\beta)\sigma^2 }}{\beta^2\eta T \lrincir{ G + (1-\beta)\sigma^2 } + (1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} } } } + 4 } \\ \nonumber 
& + (1-\beta)\lrincir{ \lrincir{T\beta(\eta + 16nL\eta^2) + 2nTL\eta^2} \sqrt{ \frac{\eta T \lrincir{ G + (1-\beta)\sigma^2 }}{\beta^2\eta T \lrincir{ G + (1-\beta)\sigma^2 } + (1-\beta) \lrincir{  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} } } } } \sigma^2 \\ \nonumber
