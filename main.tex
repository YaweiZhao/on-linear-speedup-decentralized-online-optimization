...
\end{align} Here, $\lambda$ is a normalizing constant, $\delta_{i,t}$ is a known function of the constant $\epsilon_{i,t}$ for $\epsilon_{i,t}$-differential privacy \citep{Dwork:2014gx}. For example, when $\delta_{i,t} = \epsilon_{i,t}$, $\lambda = $. In the case, $H_t(\x)$ makes the decision variable own privacy-preserving property.
