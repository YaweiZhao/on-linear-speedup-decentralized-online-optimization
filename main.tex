...
\item $\xi_{i,t}$ is drawn from a time-varying Normal distribution, that is, $\xi_{i,t} \sim N(\frac{\cos(t)}{10^3}, \I)$.
...
Second, we evaluate the speed of the increase of regret. As shown in Figure \ref{figure_regret_num_instances}, regret becomes large with the increase of the number of iterations. But, the increase of regret becomes slowly, which matches with our theoretical result, that is, the regret depends on $\sqrt{T}$.
...
\subfigure[\textit{Regret v.s. Number of instances}]{\includegraphics[width=0.45\columnwidth]{figure_regret_num_instances}\label{figure_regret_num_instances}}
