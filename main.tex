...
&+ (1-\beta) C_0  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} + 3TLG\eta^2C_0 \\ \nonumber 
...
&+ (1-\beta)n \lrincir{\frac{1}{\beta + \eta} + 4}  \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} }\lrincir{H_1(\bar{\x}_1) - H_T(\bar{\x}_{T+1}) + V} + 3nTLG\eta^2\lrincir{ \frac{1}{\beta + \eta} + 4 } \\ \nonumber 
