...
& + n\lrincir{ \frac{2}{\nu} + 8 } \lrincir{ \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} } \sum_{t=1}^T  \lrincir{H_t(\bar{\x}_t)-H_t(\bar{\x}_{t+1})} + \frac{T\eta\beta^2 G}{1-\beta}  + \frac{2GT\eta^3(1-\beta)L^2}{(1-\rho)^2}  + 2LT\eta^2 G } \\ \nonumber
=& \eta T \lrincir{ n\beta G + (1-\beta)\sigma^2}  + \frac{n}{2\eta}\lrincir{ 4\sqrt{R}M + R  } + n\lrincir{ \frac{2}{\nu} + 8 } \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} } \sum_{t=1}^T  \lrincir{H_t(\bar{\x}_t)-H_t(\bar{\x}_{t+1})} \\ \nonumber
& + \lrincir{\frac{2nT\eta \beta}{(1-\rho)^2} + \frac{4nT\eta^2 L}{(1-\rho)^2} + \frac{2nT\eta \nu}{(1-\rho)^2} + \frac{8nT\eta^3 L^2}{(1-\rho)^2} + \lrincir{\frac{2}{\nu}+8} \lrincir{ \frac{nT\eta\beta^2}{1-\beta}  + \frac{2nT\eta^3(1-\beta)L^2}{(1-\rho)^2}  + 2nLT\eta^2  } }G.
\end{align}  
$\textcircled{1}$ holds due to Lemma \ref{lemma_gradient_norm_bound} and Lemma \ref{lemma_x_variance_norm_square}. That is, we have
\begin{align}
& \frac{\eta(1-\beta)}{4}\sum_{t=1}^T \lrnorm{\nabla H_t(\bar{\x}_t)}^2 \\ \nonumber
\le & \EE_{ \Xi_{n,T-1} \sim \Dcal_{n,T-1} } \sum_{t=1}^T  \lrincir{H_t(\bar{\x}_t)-H_t(\bar{\x}_{t+1})} + \frac{T\eta\beta^2 G}{1-\beta}  + \frac{2GT\eta^3(1-\beta)L^2}{(1-\rho)^2}  + 2LT\eta^2 G.
\end{align} and
\begin{align}
\nonumber
...
= & \EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } H_t(\bar{\x}_t) + \EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrangle{\nabla H_t(\bar{\x}_t), -\frac{\eta\beta}{n}\sum_{i=1}^n \nabla g_{i,t}(\x_{i,t})} \\ \nonumber
& + \EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrangle{\nabla H_t(\bar{\x}_t), -\frac{\eta(1-\beta)}{n}\sum_{i=1}^n \nabla H_t(\x_{i,t})} + \frac{L\eta^2}{2n}\sum_{i=1}^n\EE_{ \Xi_{n,t} \sim \Dcal_{n,t} } \lrnorm{\nabla f_{i,t}(\x_{i,t};\xi_{i,t})}^2.
\end{align}
...
\nonumber
& \EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrangle{\nabla H_t(\bar{\x}_t), -\frac{\eta\beta}{n}\sum_{i=1}^n \nabla g_{i,t}(\x_{i,t})} \\ \nonumber
= & \eta \EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrangle{\nabla H_t(\bar{\x}_t), -\frac{\beta}{n}\sum_{i=1}^n \nabla g_{i,t}(\x_{i,t})} \\ \nonumber
\le &  \frac{\eta(1-\beta)}{4}\EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrnorm{\nabla H_t(\bar{\x}_t)}^2 + \frac{\eta\beta^2}{1-\beta}\EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrnorm{ \frac{1}{n}\sum_{i=1}^n \nabla g_{i,t}(\x_{i,t})}^2 \\ \nonumber
\le &  \frac{\eta(1-\beta)}{4}\EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrnorm{\nabla H_t(\bar{\x}_t)}^2 + \frac{\eta\beta^2}{1-\beta}\frac{1}{n} \EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} }  \sum_{i=1}^n \lrnorm{ \nabla g_{i,t}(\x_{i,t})}^2 \\ \nonumber
\le & \frac{\eta(1-\beta)}{4}\EE_{ \Xi_{n,t-1} \sim \Dcal_{n,t-1} } \lrnorm{\nabla H_t(\bar{\x}_t)}^2 + \frac{\eta\beta^2 G}{1-\beta},
\end{align}  and 
\begin{align}
\nonumber
& \lrangle{\nabla H_t(\bar{\x}_t), -\nabla H_t(\x_{i,t})} \\ \nonumber 
= & \frac{1}{2}\lrincir{\lrnorm{\nabla H_t(\bar{\x}_t) - \nabla H_t(\x_{i,t})}^2 -  \lrnorm{\nabla H_t(\bar{\x}_t)}^2 - \lrnorm{ \nabla H_t(\x_{i,t})}^2} \\ \nonumber
\le & \frac{1}{2}\lrincir{L^2\lrnorm{\bar{\x}_t - \x_{i,t}}^2 -  \lrnorm{\nabla H_t(\bar{\x}_t)}^2 - \lrnorm{ \nabla H_t(\x_{i,t})}^2},
\end{align}
and 
\begin{align}
\nonumber
...
Thus, telescoping $t\in[T]$, we obtain
\begin{align}
& \EE_{ \Xi_{n,T} \sim \Dcal_{n,T} } \sum_{t=1}^T H_t(\bar{\x}_{t+1}) \\ \nonumber
\le & \EE_{ \Xi_{n,T-1} \sim \Dcal_{n,T-1} } \sum_{t=1}^T  H_t(\bar{\x}_t) + \frac{\eta(1-\beta)}{4}\EE_{ \Xi_{n,T-1} \sim \Dcal_{n,T-1} } \sum_{t=1}^T\lrnorm{\nabla H_t(\bar{\x}_t)}^2 + \frac{T\eta\beta^2 G}{1-\beta} \\ \nonumber 
& + \frac{\eta(1-\beta)L^2}{2n}\sum_{t=1}^T \sum_{i=1}^n \lrnorm{\bar{\x}_t - \x_{i,t}}^2 -\frac{\eta(1-\beta)}{2}\sum_{t=1}^T \lrnorm{\nabla H_t(\bar{\x}_t)}^2 \\ \nonumber 
& - \frac{\eta(1-\beta)}{2n}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{ \nabla H_t(\x_{i,t})}^2 + 2LT\eta^2 G \\ \nonumber
\le & \EE_{ \Xi_{n,T-1} \sim \Dcal_{n,T-1} } \sum_{t=1}^T  H_t(\bar{\x}_t) + \frac{T\eta\beta^2 G}{1-\beta}  + \frac{2GT\eta^3(1-\beta)L^2}{(1-\rho)^2} -\frac{\eta(1-\beta)}{4}\sum_{t=1}^T \lrnorm{\nabla H_t(\bar{\x}_t)}^2 \\ \nonumber 
& - \frac{\eta(1-\beta)}{2n}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{ \nabla H_t(\x_{i,t})}^2 + 2LT\eta^2 G.
...
\begin{align}
& \frac{\eta(1-\beta)}{4}\sum_{t=1}^T \lrnorm{\nabla H_t(\bar{\x}_t)}^2 \\ \nonumber
\le & \frac{\eta(1-\beta)}{4}\sum_{t=1}^T \lrnorm{\nabla H_t(\bar{\x}_t)}^2 + \frac{\eta(1-\beta)}{2n}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{ \nabla H_t(\x_{i,t})}^2  \\ \nonumber
\le & \EE_{ \Xi_{n,T-1} \sim \Dcal_{n,T-1} } \sum_{t=1}^T  \lrincir{H_t(\bar{\x}_t)-H_t(\bar{\x}_{t+1})} + \frac{T\eta\beta^2 G}{1-\beta}  + \frac{2GT\eta^3(1-\beta)L^2}{(1-\rho)^2}  + 2LT\eta^2 G.
