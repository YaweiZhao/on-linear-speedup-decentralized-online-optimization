...
\icmltitlerunning{Proximal Online Gradient is Optimum for Dynamic Regret}

\begin{document}

\twocolumn[
\icmltitle{Proximal Online Gradient is Optimum for Dynamic Regret}
...
\centering 
\subfigure{\includegraphics[width=0.85\columnwidth]{figure_dynamics}\label{figure_dynamics}}
