...
\end{align}
The result suggests that $\x_{i,t}$ approaches to $\bar{\x}_t$ roughly in the rate $O(1/\sqrt{T})$, which is faster than the convergence of the averaged regret, which is roughly in the rate $O(1/\sqrt{T})$ from Corollary~\ref{XXXX}.
