...
However, this bound can also be achieved by running the online learning algorithm independently on each computational node (or user) \emph{without} any communication, since the regret of an online algorithm is $\Ocal{\sqrt{T}}$ for convex loss functions~\citep{Hazan2016Introduction,ShalevShwartz:2012dz}. This reminds us to ask a fundamental question: 

\emph{Can people really get benefit from the decentralized online learning by exchanging information?}
