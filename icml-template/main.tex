...
\le & \EE_{\Xi_{n,T} \sim \Dcal_{n,T}}\left [\sum_{i=1}^n \sum_{t=1}^T \lrincir{ \frac{\eta}{2}\lrnorm{\nabla f_{i,t}(\x_{i,t};\xi_{i,t})}^2 + \frac{1}{2\eta} \lrnorm{\x_{j,t} - \x_{i,t}}^2 }\right ] \\ \nonumber
\le & \frac{\eta n T G^2}{2} + \frac{1}{2\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{\x_{j,t} - \x_{i,t}}^2 \\ \nonumber
\le & \frac{\eta n T G^2}{2} + \frac{1}{\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}}\sum_{i=1}^n \sum_{t=1}^T \lrincir{ \lrnorm{\x_{j,t} -\bar{\x}_t}^2 + \lrnorm{\bar{\x}_t - \x_{i,t}}^2} \\ \nonumber
\le & \frac{\eta n T G^2}{2} + \frac{1}{\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{\bar{\x}_t - \x_{i,t}}^2 + \frac{n}{\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}} \sum_{t=1}^T\lrnorm{\x_{j,t} -\bar{\x}_t}^2  \\ \nonumber
\le & \frac{\eta n T G^2}{2} + \frac{1}{\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{\bar{\x}_t - \x_{i,t}}^2 + \frac{n}{\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}} \sum_{j=1}^n\sum_{t=1}^T\lrnorm{\x_{j,t} -\bar{\x}_t}^2  \\ \nonumber
\le & \frac{\eta n T G^2}{2} + \frac{1+n}{\eta} \EE_{\Xi_{n,T} \sim \Dcal_{n,T}}\sum_{i=1}^n \sum_{t=1}^T \lrnorm{\bar{\x}_t - \x_{i,t}}^2 \\ \nonumber
\le & \frac{\eta n T G^2}{2} + \frac{(1+n)nT\eta G^2}{(1-\rho)^2} 
\end{align}
